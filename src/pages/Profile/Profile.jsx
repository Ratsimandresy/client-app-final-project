...
class Profile extends React.Component {
  ...
  async componentDidMount() { /*
    ...
    */
    ...
    if (data) {
      this.setState({user: data, userEvents: data.userEvents, favEvents: data.events, isLoading: false});
    }
  }
  ...
  */
  ...
  handlerClickDeleteFavEvent = (favEventId) => {
    ...
    apiHandler.updateOne("api/user/fav-event", {favorites: newFavEvents})
    .then((resApi) => {
  ...
  render() { // console.log(this.props.context.user.email);
